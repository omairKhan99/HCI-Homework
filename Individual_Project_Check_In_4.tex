...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Prototype2_Personalized Dashboard.jpg}
    \caption{This is an idea of what Personalized Dashboard I want}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Check_in3.jpg}
